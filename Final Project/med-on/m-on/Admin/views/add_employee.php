...
<body>
    ...
    <form name="form" action="../controller/RegController.php" method="post" onsubmit="return validateAdd()">
        <fieldset>
            <legend>Hire an employee</legend>
            <table>
                <tr>
                ...
                <tr>
                    <td> <input type="button" id="submit" name="submit" value="Confirm" onclick="addEmployee()"></td>
...
function addEmployee(){
    ...
    xhttp.open("POST", "../controller/regController2.php", true);
